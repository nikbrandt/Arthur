exports.run = (message, a, s, d, permLevel) => {
	...
	if (!message.guild.music || !message.guild.music.queue || !message.guild.voice || !message.guild.voice.connection || !message.guild.voice.connection.dispatcher) return message.channel.send(message.__('no_music_playing'));
